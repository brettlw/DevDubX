...
Our Team
---
 - [sinful](https://github.com/brettlw) __(Founder/Owner/Developer)__
...
* If this does not work, go to `https://cdn.jsdelivr.net/gh/brettlw/DevDubX/beta.js` and copy paste its content into your console (accessible in chrome by pressing f12) when on Dubtrack.fm in a community.

-----------------
Custom CSS
---

* plug.dj theme made by Kris and edited by sinful. Paste `https://cdn.jsdelivr.net/gh/brettlw/DevDubX/themes/PlugTheme.css` in the Custom CSS option in Dub X, then click 'Okay'

...
if (!hello_run && Dubtrack.session.id && !ifUserBanned) {
                ...
                '<div class="for_content">',
                    ...
                    '<ul class="for_content_ul">',
                        ...
                        '<ul class="draw_social">',
                            ...
                            '</li>',
                            '<li class="for_content_li for_content_feature">',
                                '<a href="https://github.com/brettlw/DevDubX" target="_blank" style="color: #878c8e;">',
    ...
    function onErr(error) {
        var onErr = [
            '<link rel="stylesheet" type="text/css" href="https://raw.githubusercontent.com/brettlw/DevDubX/master/css/asset.css">',
            '<div class="onErr">',
                '<div class="container">',
                    '<div class="title">',
                        '<h1>Oh noes:</h1>',
